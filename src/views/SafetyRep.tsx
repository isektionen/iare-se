...
const View = ({ header, footer }: LayoutProps<{}>) => {
    ...
    return (
        <React.Fragment>
            <NextSeo title={makeTitle(t("seo:safety-rep.title"))} />

            <VStack h="full" w="full" align="stretch">
                <Center bg="lightgray" h="100px" color="white">
                    <Link
                        href="https://forms.gle/6ECBhrTH2dMWk2Fd9"
                        color="black"
                        isExternal
                    >
                        {lang == "sv"
                            ? "Skyddsombudets via Google Formulär"
                            : "Safety representative contact by Google Forms"}{" "}
