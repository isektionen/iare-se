...
export type DocumentAllDocumentsDynamicZone =
    ...
    | ComponentDocumentFinancialReportDocument;
...
export type Morph =
    ...
    | OatComponentEventTicketReference
    | OatCommittee
    | OatPlace
    | OatEvent
    | OrderAsTicket
    ...
    | AllergyConnection
    | AllergyAggregator
    | AllergyAggregatorSum
    | AllergyAggregatorAvg
    | AllergyAggregatorMin
    | AllergyAggregatorMax
    | AllergyGroupBy
    | AllergyConnectionId
    | AllergyConnectionCreated_At
    | AllergyConnectionUpdated_At
    | AllergyConnectionName
    | AllergyConnectionCount
    | AllergyConnectionLocale
    | AllergyConnectionPublished_At
    | CreateAllergyPayload
    | UpdateAllergyPayload
    | DeleteAllergyPayload
    | Category
    | CategoryConnection
    | CategoryAggregator
    | CategoryGroupBy
    ...
    | ChapterYear
    | ChapterYearConnection
    | ChapterYearAggregator
    | ChapterYearGroupBy
    | ChapterYearConnectionId
    | ChapterYearConnectionCreated_At
    | ChapterYearConnectionUpdated_At
    | ChapterYearConnectionLabel
    | ChapterYearConnectionUser
    ...
    | CommitteeConnectionCreated_At
    | CommitteeConnectionUpdated_At
    | CommitteeConnectionName
    | CommitteeConnectionLocale
    | CommitteeConnectionPublished_At
    ...
    | CompanyConnectionLogo
    | CompanyConnectionWebsite
    | CompanyConnectionBackgroundColor
    | CompanyConnectionSponsor
    | CompanyConnectionLocale
    | CompanyConnectionPublished_At
    ...
    | DietGroupBy
    | DietConnectionId
    | DietConnectionCreated_At
    | DietConnectionUpdated_At
    | DietConnectionName
    | DietConnectionCount
    | DietConnectionLocale
    | DietConnectionPublished_At
    | CreateDietPayload
    | UpdateDietPayload
    | DeleteDietPayload
    | Document
    ...
    | EventCategoryAggregator
    | EventCategoryGroupBy
    | EventCategoryConnectionId
    | EventCategoryConnectionCreated_At
    | EventCategoryConnectionUpdated_At
    | EventCategoryConnectionName
    | EventCategoryConnectionLocale
    | EventCategoryConnectionPublished_At
    ...
    | EventConnectionSlug
    | EventConnectionCommittee
    | EventConnectionCategory
    | EventConnectionTickets
    | EventConnectionServingOptions
    | EventConnectionStudentOptions
    | EventConnectionStartTime
    | EventConnectionEndTime
    | EventConnectionDeadline
    | EventConnectionDescription
    | EventConnectionPlace
    | EventConnectionPasswordProtected
    | EventConnectionBanner
    | EventConnectionFullfillmentUid
    | EventConnectionLocale
    ...
    | JobCategoryAggregator
    | JobCategoryGroupBy
    | JobCategoryConnectionId
    | JobCategoryConnectionCreated_At
    | JobCategoryConnectionUpdated_At
    | JobCategoryConnectionName
    | JobCategoryConnectionLocale
    | JobCategoryConnectionPublished_At
    | CreateJobCategoryPayload
    | UpdateJobCategoryPayload
    | DeleteJobCategoryPayload
    | Jobs
    | JobsConnection
    | JobsAggregator
    | JobsGroupBy
    ...
    | JobsConnectionTitle
    | JobsConnectionSlug
    | JobsConnectionDeadlineDate
    | JobsConnectionStartDate
    | JobsConnectionJobCategory
    | JobsConnectionCompany
    | JobsConnectionBody
    | JobsConnectionPosition
    | JobsConnectionLocation
    | JobsConnectionLocale
    | JobsConnectionPublished_At
    | CreateJobPayload
    | UpdateJobPayload
    | DeleteJobPayload
    | Order
    ...
    | PostConnectionSlug
    | PostConnectionAdminUser
    | PostConnectionCommittee
    | PostConnectionBody
    | PostConnectionBanner
    ...
    | UsersPermissionsUserConnectionChapter_Year
    | CreateUserPayload
    | UpdateUserPayload
    | DeleteUserPayload
    | ComponentDocumentActionDocument
    ...
    | ComponentEventPasswordProtect
    | ComponentEventPlace
    | ComponentEventRecipient
    | ComponentEventServing
    | ComponentEventStudent
    | ComponentEventTicketReference
    ...
    | ComponentJobAbout
    | ComponentJobContact
    | ComponentJobDescription
    | ComponentJobImage
    | ComponentJobMail
    | ComponentJobRequirements
    | ComponentJobTaskItem
    | ComponentJobTasks
    | ComponentJobYear;
...
export type UsersPermissionsUserGroupBy = {
    ...
    chapter_year?: Maybe<
        Array<Maybe<UsersPermissionsUserConnectionChapter_Year>>
    >;
};
...
export type EditComponentFormCheckboxInput = {
    ...
    label?: Maybe<Scalars["String"]>;
    checkBox?: Maybe<
        Array<Maybe<EditComponentFormInternalsCheckboxOptionInput>>
    >;
};
...
export type EditOrderInput = {
    ...
    event?: Maybe<Scalars["ID"]>;
    ticketReference?: Maybe<
        Array<Maybe<EditComponentEventTicketReferenceInput>>
    >;
    ip?: Maybe<Scalars["String"]>;
    reference?: Maybe<Scalars["String"]>;
    amount?: Maybe<Scalars["Float"]>;
